...
public interface RequestService {
    ...
    Request createUserRequest(Long userId, Long assetId,int requestedQuantity);
...
//    Request approveRequest(Long requestId);
    ...
    void createSystemRequestForBrokenAsset(Long assignmentId, Long userId,int brokenCount);
